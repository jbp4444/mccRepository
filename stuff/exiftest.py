...
def main():
	...
	try:
		filepath = "other.jpg"
		exif_dict = generate_exif_dict(filepath)

		print_exif_dict(exif_dict)

		print( 'DateTime: ' + str(exif_dict['DateTime']['processed']) )
		print( exif_dict['Make']['processed'] +','+ exif_dict['Model']['processed'] +
			','+ exif_dict['Software']['processed'] )
